...
TDE_CLIENT_COUNT=0
TMUX=
run_test "Dry-run with 3 columns; session mysession" \
    "./tde -p 4 --columns 3 -s mysession -w mywindow $PROJECT1" \
...
TDE_CLIENT_COUNT=1
TMUX=tde
run_test "Dry-run with 4 columns" \
    "./tde -p 4 -x 4 $PROJECT1" \
    "tmux new-window -t tde: -c /tmp/test-tde/project1 -n project1
tmux set-option -t tde:999 pane-base-index 1
tmux split-window -h -t tde:999 -c /tmp/test-tde/project1
tmux split-window -h -t tde:999 -c /tmp/test-tde/project1
...
TDE_CLIENT_COUNT=1
TMUX=tde
run_test "Multiple project directories with default panes" \
...
TDE_CLIENT_COUNT=1
TMUX=tde
run_test "Multiple project directories with 3 panes" \
...
TDE_CLIENT_COUNT=1
TMUX=tde
run_test "Multiple project directories with a launch command in pane 1" \
...
TDE_CLIENT_COUNT=1
TMUX=tde
run_test "Multiple project directories with a launch command in pane 2" \
...
TDE_CLIENT_COUNT=1
TMUX=tde
run_test "Multiple project directories with a launch command in pane 3" \
...
TDE_CLIENT_COUNT=1
TMUX=tde
run_test "Multiple project directories with multiple launch commands" \
...
TDE_CLIENT_COUNT=1
TMUX=tde
run_test "Invalid --columns value 'abc'" \
    "./tde -x abc -p 2 $PROJECT1" \
    "tde: error: invalid --columns option 'abc': must be between 1 and 9" 1

TDE_CLIENT_COUNT=1
TMUX=tde
run_test "Invalid --columns value '9'" \
    "./tde -x 0 -p 2 $PROJECT1" \
    "tde: error: invalid --columns option '0': must be between 1 and 9" 1
...
TDE_CLIENT_COUNT=1
TMUX=tde
run_test "Invalid --columns value '3'" \
    "./tde -x 3 -p 2 $PROJECT1" \
    "tde: error: invalid --columns option '3': must be between 1 and 2" 1
