...
echo "Test Case 1: Basic dry-run with a single directory"
...
echo "Test Case 2: Dry-run with 2 panes"
...
echo "Test Case 3: Dry-run with 2 panes and explicit pane 1 launch command"
...
echo "Test Case 4: Dry-run with 2 panes and implicit pane 1 launch command"
...
echo "Test Case 5: Multiple project directories with default panes"
...
echo "Test Case 6: Multiple project directories with 3 panes"
...
echo "Test Case 7: Multiple project directories with a launch command in pane 1"
...
echo "Test Case 8: Multiple project directories with a launch command in pane 2"
...
echo "Test Case 9: Multiple project directories with a launch command in pane 3"
...
echo "Test Case 10: Multiple project directories with multiple launch commands"
...
echo "Test Case 11: Single project directory with 4 panes"
...
echo "Test Case 12: Single project directory with 4 panes and multiple launch commands"
...
echo "Test Case 13: Single project directory with 4 panes and a launch command in pane 4"
...
echo "Test Case 14: Multiple project directories with 5 panes and a launch command in pane 1"
...
echo "Test Case 15: Multiple project directories with 5 panes and a launch command in pane 3"
...
echo "Test Case 16: Multiple project directories with 5 panes and a launch command in pane 5"
...
echo "Test Case 17: Multiple project directories with 2 panes and multiple launch commands"
...
echo "Test Case 18: Multiple project directories with 1 pane and a launch command in pane 1"
...
echo "Test Case 19: Multiple project directories with 4 panes and multiple launch commands"
...
echo "Test Case 20: Multiple project directories with 2 panes, and a launch command with a complex string"
...
echo "Help message (first two lines)"
